...
public class UIcadastro extends javax.swing.JFrame {
  String senhaUsuario, emailUsuario,nomeUsuario,dataUsuario;
   ...
   void Salvando(){
            ...
            System.out.println("Nome que foi Cadastrado:" + nomeUsuario);
            System.out.println("Email que foi Cadastrado:" + emailUsuario);
            System.out.println("Data que foi Cadastrada:" + dataUsuario);
            System.out.println("Senha que foi Cadastrado:" + senhaUsuario);
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 460, 150, 30));
        ...
        jPanel1.add(btnConfirmar, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 390, 140, 40));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Loja/Fundo.jpg"))); // NOI18N
        ...
        setSize(new java.awt.Dimension(412, 539));
    ...
    void Salvar(JTextField textLogin) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    void Loginn(com.sun.org.apache.xalan.internal.xsltc.compiler.util.Type String) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    void Loginn(String email) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
}
